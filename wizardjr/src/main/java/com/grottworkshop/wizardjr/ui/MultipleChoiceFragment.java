...
package com.grottworkshop.wizardjr.ui;
...
import com.grottworkshop.wizardjr.R;
...
public class MultipleChoiceFragment extends ListFragment {
    ...
    private IPageFragmentCallbacks mCallbacks;
    private String mKey;
    ...
    public void onAttach(Activity activity) {
        ...
        if (!(activity instanceof IPageFragmentCallbacks)) {
            throw new ClassCastException("Activity must implement PageFragmentCallbacks");
        }

        mCallbacks = (IPageFragmentCallbacks) activity;
    }
